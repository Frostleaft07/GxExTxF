...
date=`date +%Y%m%d`
outputname="$romtypename-$outputtype-$sourcever-$date"
...
echo "The size of the original image after merging: $(bytesToHuman $systemsize)" >> "$outputinfo"
echo "ROM：$romtype" >> "$outputinfo"
