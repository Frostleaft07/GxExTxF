...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
    ...
    if [[ "$distro" == "arch" || "$id_like" == "arch" ]]; then
       ...
       sudo pacman -S --needed unace unrar zip unzip p7zip sharutils uudeview arj cabextract file-roller dtc xz brotli lz4 gawk libmpack aria2 python3-pip python-pip 
       #aur=rar
    else
